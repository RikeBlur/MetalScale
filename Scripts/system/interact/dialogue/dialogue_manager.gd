...
func _process(_delta: float) -> void:
	...
	for i in range(trigger_flag.size()):
		if trigger_flag[i].flag :
			if !trigger_flag[i].double: _spawn_dialogue(trigger_flag[i].style[0]-1, trigger_flag[i].start[0], trigger_flag[i].end[0])				
			if trigger_flag[i].double: _spawn_dual_dialogue(trigger_flag[i].style[0]-1, trigger_flag[i].start[0], trigger_flag[i].end[0], trigger_flag[i].a_index, trigger_flag[i].b_index)						
