...
func _on_enter() -> void:
	...
	speed_min = Character_body.get_npc_int_property("player_walk_speed_min", speed_min)
	speed_max = Character_body.get_npc_int_property("player_walk_speed_max", speed_max)
	accelaration = Character_body.get_npc_int_property("player_walk_acceleration", accelaration)
	if sfx:
		sfx.play_start()
...
func _resolve_references() -> void:
	...
	if sfx == null and Character_body:
		sfx = Character_body.get_node_or_null("SFXManager/walk") as SFXPlayer
