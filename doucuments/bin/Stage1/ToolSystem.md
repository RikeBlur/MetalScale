...
config == 2 的 Tool 需要在字典类 consumption 中设置持有量。<br>
...
state ： 0 未激活、1 已激活、2 不可激活； <br>
tool ： 对应的 Tool； <br>
config ： 对应的 Tool 的 config； <br>
icon ： 对应的图标； <br>
durability ： 对应的耐久条（对应场景 DURABILITY_BAR_SCENE ）<br>

重要方法 **更新 ToolBox 样式** update_children_based_on_config ： config == 0 时，清除 icon 外所有子节点；
